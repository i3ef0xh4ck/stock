 ...
 * 同时要得到下期必增的推测  
 * */
public class Timer预告_4解决分页问题_toExcel {
  //顾地科技
  ...
  System.out.println("总入口："+url3);
        ...
        //  formatDate = "2017-06-30";
          String formatDate2 = "2018-01-07";
          String formatDate3 = "2018-01-08";
          String formatDate4 = "2018-01-09";
          String formatDate5 = "2018-01-10";
          String formatDate6 = "2018-01-11";
          String formatDate7 = "2018-01-12";
          String formatDate8 = "2018-01-13";
